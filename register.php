  ...
  <body>
    <div class="container">
      ...
      <form class="register" action="register.php" method="post" enctype="multipart/form-data">
        ...
        <?php if(isset($errors['avatar'])) { ?><small><span class="error"><? echo $errors['avatar']?></span></small><br><?php } else { echo "<br>"; } ?>
        ...
        <?php if(isset($errors['terms'])) { ?><br><small><span class="error"><? echo $errors['terms']?></span></small><br><?php } else { echo "<br>"; } ?>
