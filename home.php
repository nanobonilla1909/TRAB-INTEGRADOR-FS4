...
<body>
    <div class="container">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="#">Pale ale</a>
                                </li>
                                <li><a href="#">IPA</a>
                                </li>
                                <li><a href="#">Scotch ale</a>
                                </li>
                                <li><a href="#">Honey</a>
                                </li>
                                <li><a href="#">Porter</a>
        ...
        <div class="jumbotron">
            ...
            <p>...</p>
            <p><a class="btn btn-primary btn-lg" href="#" role="button">Ver</a>
            </p>
        </div>
        <div class="container-fluid">
          <div class="row">
              <div class="col-sm-6 col-md-3">
                  <div class="thumbnail">
                      ...
                      <div class="caption">
                          ...
                          <p><a href="#" class="btn btn-primary" role="button">Comprar</a> <a href="#" class="btn btn-default" role="button">Detalles</a>
                          </p>
                      </div>
                  </div>
              </div>
