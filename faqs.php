...
<html>
  ...
  <div class="panel-heading">
    <h3 class="panel-title">¿Cuanto dura la cerveza sin abrir?</h3>
  </div>
  <div class="panel-body">
    Se recomienda consumir antes de cumplirse los 6 meses de la producción de la misma.
  </div>

  <div class="panel-heading">
    <h3 class="panel-title">¿Todas las cervezas tienen la misma graduación alcoholica?</h3>
  </div>
  <div class="panel-body">
    No, depende del periodo de fermentación y las proporciones en los ingredientes de la misma.
  </div>
</div>
    </div>
  </body>
